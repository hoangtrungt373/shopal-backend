...
drop table if exists config.CATALOG_STATUS_LAN;
...
CREATE TABLE config.CATALOG_STATUS_LAN (
	CATALOG_STATUS_LAN_ID		INT				NOT NULL	IDENTITY,
	CODE						VARCHAR(50)		NOT NULL,
	LAN							VARCHAR(4)		NOT NULL,
	DESCRIPTION					NVARCHAR(255)	NOT NULL

	CONSTRAINT PK_CATALOG_STATUS_LAN PRIMARY KEY (CATALOG_STATUS_LAN_ID),
);
